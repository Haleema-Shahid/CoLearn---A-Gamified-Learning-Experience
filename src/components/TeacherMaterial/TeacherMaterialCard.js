//this is one card for teacher material
//teacher material is a simple post with title description and files.
//these are different from helping material as they are not hidden
...
function TeacherMaterialCard(props) {
