...
function StMaterialViewer() {
    ...
    useEffect(() => {
        const fetchMaterial = async () => {
            try {
                const response = await fetch(`http://localhost:4000/backend/s/${userId}/class/${classId}/week/${weekId}/topic/${topicId}/material/${materialId}`);
...
export default StMaterialViewer;
